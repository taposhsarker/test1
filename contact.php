...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	if(empty($body)){
		$errorb = "Massage Field must not be empty !";
	}


	 * From validation 2nd rule
	 */
	if(empty($fname)){
			...
			<form action="" method="post">
				...
				<tr>
					...
					<td>
						...
						/*2nd rule
						if(isset($errorf)){
							echo "<span class='cuseror'>$errorf</span>";
						}*/
						?>
				...
				<tr>
					...
					<td>
						...
						/*2nd rule
						if(isset($errorl)){
							echo "<span class='cuseror'>$errorl</span>";
						}*/
						?>
				...
				<tr>
					...
					<td>
						...
						/* 2nd rule
						if(isset($errore)){
							echo "<span class='cuseror'>$errore</span>";
						}*/
						?>
				...
				<tr>
					...
					<td>
						...
						/*2nd rule
						if(isset($errorb)){
							echo "<span class='cuseror'>$errorb</span>";
						}*/
						?>
